...
<h1>${escapeHtml(model.cityName)} · ${escapeHtml(model.source)}${model.isApproximate ? ' <span class="current-best-ring" title="当前最佳路线，计算未完成" aria-label="当前最佳路线，计算未完成"></span>' : ""}</h1>
